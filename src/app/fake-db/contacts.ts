export class ContactsFakeDb
{
    public static contacts = [
        ...
        },
        {
            ...
            'name'    : '',
            'lastName': 'Casimiro MDQ',
            'avatar'  : 'assets/images/avatars/casimiro.png',
            'nickname': 'Casimiro',
            'company' : 'Empresa',
        ...
        },
        {
            ...
            'name'    : '',
            'lastName': 'Grupo Fava',
            'avatar'  : 'assets/images/avatars/fava.jpg',
            'nickname': 'Efectivo SI',
            'company' : 'Empresa',
            'jobTitle': 'Financiero',
        ...
        {
            'id'      : '5725a6806065883420583565',
            'name'    : 'Gustavo',
            'lastName': 'Simaro',
            'avatar'  : 'assets/images/avatars/gustavo-simaro.jpg',
            'nickname': 'Gus',
            'company' : 'Estudio Simaro Torchelli',
            'jobTitle': 'Contador',
            'email'   : 'gustavosimaro@simarotorchelli.com.ar',
            'phone'   : '249-444-1501',
            'address' : 'Garibaldi 522, Tandil',
            'birthday': null,
            'notes'   : ''
        },
        {
            'id'      : '5725a6806065883420583566',
            'name'    : 'Valeria',
            'lastName': 'Torchelli',
            'avatar'  : 'assets/images/avatars/valeria-torchelli.jpg',
            'nickname': 'Gus',
            'company' : 'Estudio Simaro Torchelli',
            'jobTitle': 'Contador',
            'email'   : 'valeriatorchelli@simarotorchelli.com.ar',
            'phone'   : '249-444-1501',
            'address' : 'Garibaldi 522, Tandil',
            'birthday': null,
            'notes'   : ''
        ...
        {
            'id'      : '5725a680606588342058357d',
            'name'    : 'Luis',
            'lastName': 'Rodriguez',
            'avatar'  : 'assets/images/avatars/fargo.png',
            'nickname': 'Fargo',
            'company' : 'Fargo',
            'jobTitle': 'Panificados',
            'email'   : 'luisrodriguez@fargo.com.ar',
            'phone'   : '11-2555-0141',
            'address' : 'Gral. Pinto 1322, Tandil',
            'birthday': null,
            'notes'   : ''
        },
        {
            ...
            'nickname': 'Gus',
            'company' : 'Othar Bagu Contadores',
            'jobTitle': 'Contador',
            'email'   : 'jorge@otharbagu.com.ar',
            'phone'   : '249-444-1501',
            'address' : 'Garibaldi 961, Tandil',
            'birthday': null,
            'notes'   : ''
        },
        {
            ...
            'name'    : '',
            'lastName': 'Adunce',
            'avatar'  : 'assets/images/avatars/pymex_ico.png',
            'nickname': 'Adunce',
            'company' : 'Gremio',
            'jobTitle': 'Docente',
